...
const OverviewTab = ({ selectedProject }) => {
  const status = selectedProject?.status || "Inprogress";
  const statusClass = selectedProject?.statusClass || "warning";
                  ...
                  <Row>
                    ...
                    <Col lg={3} sm={6}>
                      <div>
                        ...
                        <div className={`badge bg-${statusClass} fs-12`}>
                          {status}
                        </div>
                      </div>
                    </Col>
